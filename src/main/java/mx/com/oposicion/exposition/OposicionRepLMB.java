...
@Controller
@Scope(value = "view")
public class OposicionRepLMB implements Serializable {
    ...
    private OposicionLazyDataModel oposicionLazyDataModel;
...
//          expireUserSessions(this.user.getUsername());
        ...
        if(!loginMB.getAccessRol("PERFIL_FONETICO,PERFIL_FIGURATIVO")){
              try {
                  ...
                  Logger.getLogger(OposicionRepLMB.class.getName()).log(Level.SEVERE, null, ex);
              }
        }
...
public void expireUserSessions(String username) {
    ...
    public void handleFileUpload1(FileUploadEvent event) {
        this.tipoBusqueda=2;
        String path = OposicionRepLMB.class.getResource("OposicionRep2MB.class").getPath();
...
//                    oposicionLazyDataModel = new OposicionLazyDataModel(oposicionResultados);
                    if(sinCeros){
...
//               if(sinCeros) borraFonetic(1);
    ...
    public void searchFonetico() {
        ...
        System.out.println("Registros cargados: " + numLine + ", se generará el Fonetico");
        BusquedaFonetica busquedaFonetica=new BusquedaFonetica();
         try {
...
//               if(sinCeros) borraFonetic(1);
               ...
               message = "Se encontraron "+oposicionResultados.size()+" registros en ["+String.format("%02d min, %02d seg", 
    ...
    public void searchFigurativo(int bClase) {
        ...
        System.out.println("Registros cargados: " + numLine + ", se generará el Figurativo");
...
public static boolean isInteger(String s) {
         ...
         try{
             ...
             if(oposicionDataFig.getReporteFigurativo()==null){
              ...
              List<OposicionData> oDataModelTmp=new ArrayList<OposicionData>();
                for (OposicionData opTmp : oposicionLazyDataModel) {
 ...
 public byte[] generateDocumentF2(String basePath, OposicionData od ,List<mx.com.oposicion.model.Gacetadata> gacetadata,int clase) throws Exception {
    ...
    public OposicionLazyDataModel getOposicionLazyDataModel() {
        return oposicionLazyDataModel;
    }

    public void setOposicionLazyDataModel(OposicionLazyDataModel oposicionLazyDataModel) {
        this.oposicionLazyDataModel = oposicionLazyDataModel;
    }
     ...
     public void guardaDetalle2() {
         ...
         for (OposicionData oposicionData : oposicionResultados) {
            ...
            oResultados.add(oposicionData);
             ...
             oposicionLazyDataModel = new OposicionLazyDataModel(oResultados);
