...
public class GacetadataDataModel extends ListDataModel<Gacetadata> implements SelectableDataModel<Gacetadata> {    
  
    public GacetadataDataModel() {  
    }  
  
    public GacetadataDataModel(List<Gacetadata> data) {  
        super(data);  
    }  
