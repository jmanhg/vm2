...
@Controller
@Scope(value = "view")
public class GacetaMB implements Serializable {
...
//          expireUserSessions(this.user.getUsername());
        ...
        if(!loginMB.getAccessRol("PERFIL_FONETICO,PERFIL_FIGURATIVO")){
              try {
                  ...
                  Logger.getLogger(GacetaMB.class.getName()).log(Level.SEVERE, null, ex);
              }
        }
    ...
    public void searchRegistroF(int op){
        ...
        if(op==1 || (op==0 && (this.idRegistro>0 ||
                ...
                (this.denominacion!=null && this.denominacion.length()>0) ||
                 ...
                 (this.gaceta!=null && this.gaceta.length()>0) ||
                 (this.fechaPub1!=null) ||
                 (this.fechaPub2!=null) ||
            ...
            if(this.gaceta!=null && this.gaceta.length()>0) g.setGaceta(this.gaceta);
            if(this.fechaPub1!=null ) g.setfRegistro(this.fechaPub1);
            if(this.fechaPub2!=null ) g.setPresentacion(this.fechaPub2);
...
//        }
    ...
    public void handleFileUpload1(FileUploadEvent event) {
        this.tipoBusqueda=2;
        String path = GacetaMB.class.getResource("OposicionRep2MB.class").getPath();
