...
public class FigurativoDataModel extends ListDataModel<Gacetadata> implements SelectableDataModel<Gacetadata> {    
  
    public FigurativoDataModel() {  
    }  
  
    public FigurativoDataModel(List<Gacetadata> data) {  
        super(data);  
    }  
